...
;(function (name, definition) {
  ...
  MeScroll.prototype.extendDownScroll = function(optDown) {
    ...
    //下拉刷新的布局内容
	var htmlContent = '';
//	htmlContent += '<img class="downwarp-slogan" src="../beibei/option/mescroll-slogan.jpg"/>';
	//转圆○
  ...
  MeScroll.prototype.extendUpScroll = function(optUp) {
    ...
    //实线圈
//  var htmlLoadContent = '<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip">加载中..</p>';
   //短线圈
    var htmlLoadContent = '<p class="upwarp-progress-line mescroll-rotate"></p><p class="upwarp-tip">加载中..</p>';
    ...
    MeScroll.extend(optUp, {
      ...
      leftAndRight: null, //左右滑动的回调;function(data){ }
      page: {
      ...
      htmlLoading: htmlLoadContent, //上拉加载中的布局
  ...
  MeScroll.prototype.initDownScroll = function() {
    ...
    function touchstartEvent(e) {
      ...
      if(me.optDown.mustToTop) {
        ...
        me.startX = e.touches ? e.touches[0].pageX : e.clientX; //如果列表必须滑动到顶部才能下拉,则记录此时第一个手指距离列表顶部的距离
      }
    }
    ...
    function touchmoveEvent(e) {
      ...
      if(me.startTop != null && me.scrollDom.scrollTop <= 0 && !me.isDownScrolling && (!me.isUpScrolling || (me.isUpScrolling && me.optUp.isBoth)) && !me.optDown.isLock) {
        ...
        var moveX = curX - me.startX; //和起点比,移动的距离,大于0向右
		console.log("moveX==="+moveX);
		if (Math.abs(moveX)>Math.abs(moveY)) {
			if (moveX>5) {
				me.optUp.leftAndRight&&me.optUp.leftAndRight("right");
			}
			if (moveX<-5) {
				me.optUp.leftAndRight&&me.optUp.leftAndRight("left");
			}
			return
		}
