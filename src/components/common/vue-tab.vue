<template>
    <div class="tab-container">
        <ul :style="ulStyle" class="tab-title-container">
            <li class="tab-title"
                v-for="(title,index) in tabtitles" 
                :style="'background:'+(index+1===currentPage?bgColor:'#fff')+';color:'+(index+1===currentPage?selColor:'')+';border-bottom:'+(index+1===currentPage?' 2px solid '+selColor+';':'')+itemStyle"
                :key="index"
